...
if (exp && (!exp.data || exp.schema !== 5)) fail.push('export missing data/schema');
...
if (migrated.version !== 5 || !migrated.hasReminders || !migrated.hasBoss) fail.push('v1 migration incomplete: ' + JSON.stringify(migrated));
